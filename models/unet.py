from models.layers import weight_variable,bias_variable,\
    conv2d_activtion,max_pool,deconv2d_concat,conv2d,conv2d_atrous
...
a = tf.constant(1.0,shape=[10,256,256,3])
b = unet(a,batch_norm=True,n_class=5,features=16)
sess = tf.Session()
